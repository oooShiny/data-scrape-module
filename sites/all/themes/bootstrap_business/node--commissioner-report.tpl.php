<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
    ...
    <div class="embed-code">
      <p>To put this Commissioner Report into your ESPN site, copy the code below:</p>
      <code>&lt;iframe src="http://<?php print $_SERVER['HTTP_HOST'].'/print/'.$nid; ?>" style="width: 660px; height: 880px;" &gt;&lt;/iframe&gt;</code>
